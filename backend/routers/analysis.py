...
FREE_FRAMEWORKS = {"pestel", "swot", "tam", "bmc", "porter", "stp", "bcg", "value_chain"}
...
class AnalysisRequest(BaseModel):
    ...
    frameworks: list[str] = ["pestel", "swot", "tam", "bmc", "porter", "stp", "bcg", "value_chain"]
...
def list_frameworks():
    ...
    return {
        ...
        "paid": ["ansoff", "balanced_scorecard"],
    }